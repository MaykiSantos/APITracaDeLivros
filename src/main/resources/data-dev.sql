INSERT INTO `categoria` (`dtype`, `id`, `created`, `delete_soft`, `nome`, `updated`) VALUES 
...
INSERT INTO `chamado` (`id`, `atendido`, `created`, `delete_soft`, `descricao`, `titulo`, `updated`, `cliente_id`) VALUES 
...
INSERT INTO `estoque` (`id`, `corredor`, `created`, `delete_soft`, `prateleira`, `updated`) VALUES 
...
INSERT INTO `pedido_reposicao` (`id`, `created`, `data_entraga`, `delete_soft`, `descricao`, `obs`, `updated`, `valor`, `fornecedor_id`, `funcionario_id`) VALUES 
...
INSERT INTO `produto` (`dtype`, `id`, `created`, `delete_soft`, `descricao`, `disponivel`, `nome`, `porcentagem_desconto`, `updated`, `valor`, `acabamento`, `altura`, `autor`, `idioma`, `largura`, `numero_paginas`, `pais`, `peso`, `profundidade`, `estoque_id`, `fornecedor_id`, `funcionario_id`) VALUES 
